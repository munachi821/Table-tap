      ...
      <div className="w-68 h-full shrink-0 border-r border-gray-100 bg-orange-400">
        ...
        <div className="p-4">
          <ul className="flex flex-col gap-2">
            {admintabs.map((tab) => (
              <li
                className={`flex items-center gap-2 text-lg ${activeTab === tab.name ? "font-semibold text-orange-800 bg-[#FEF3C7]/80" : "text-white hover:bg-gray-100/30"} p-2.5 rounded-md cursor-pointer transition-all`}
                key={tab.name}
